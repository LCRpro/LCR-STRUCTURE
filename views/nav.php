...
<nav class="bg-white  fixed w-full z-20 top-0 start-0 border-b border-gray-200 d">
  ...
  <a href="./" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl animated-text font-bold uppercase whitespace-nowrap">LIAM CARIOU</span>
  </a>
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <a href="Contact"  class="text-white bg-indigo-500 hover:bg-indigo-900 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-8 py-2 text-center ">Contact</a>
